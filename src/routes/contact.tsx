...
function ContactPage() {
  ...
  const onSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    trackEvent("contact_form_submit", { experience: form.experience });
    window.open(
      whatsappLink({
  ...
  return (
    <div className="container-page py-10">
      ...
      <p className="mt-3 max-w-2xl text-muted-foreground">
        Tell us what you'd like to do in Bali and we'll reply with availability and the total price.
      </p>
        ...
        <form onSubmit={onSubmit} className="max-w-xl space-y-4">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <div>
              ...
              <input id="guests" inputMode="numeric" className={field} value={form.guests} onChange={set("guests")} />
            </div>
          </div>
          <div>
            ...
            <input id="pickup" className={field} value={form.pickup} onChange={set("pickup")} />
          </div>
          <button
            type="submit"
