  ...
  return (
    <div className="container-page py-10">
      ...
      <div className="mt-6 max-w-2xl space-y-4 text-muted-foreground">
        <p>
          {siteConfig.name} helps travelers discover Bali through adventure, wildlife, family
          experiences, scenic attractions, private tours, transportation and island days.
        </p>
        <p>
        ...
        <p>
          Most of our guests come from Australia, the USA, the UK, Canada, New Zealand, Singapore,
          India, the Middle East and Europe — families, couples, solo travelers and groups.
        </p>
      </div>
      <div className="mt-8">
        <WhatsAppButton />
