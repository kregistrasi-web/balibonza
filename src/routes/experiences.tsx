...
const pageTitle = "Bali Activities & Experiences | BaliBonza";

const pageDescription =
  "Explore Bali activities and experiences including ATV, buggy adventures, Bali Zoo, Bali Safari, Bali Swing, private tours, Nusa Penida trips, snorkeling and transport.";
